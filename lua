if getgenv().guyhub then warn("guyhub : Already executed!") return end
getgenv().hub = true
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | Guy HUB - V4",
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/kt5AvQHfbA") -- discord link
        end
    })
